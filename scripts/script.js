...
function addtask(task){
    ...
    iDiv.style.border="0px solid black"
    ...
    iDivtxt.style.padding="15px 10px 15px 15px";
    ...
    iDivDel.style.backgroundColor="rgb(255, 65, 65";
    iDivDel.style.color="white";
    iDivDel.style.borderRadius="13px";
    iDivDel.style.border = "0px solid black"
